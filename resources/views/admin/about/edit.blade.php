        ...
        <form  method="POST" action="{{ route('admin.about.update',['about'=>$about])}}" enctype="multipart/form-data" >
          ...
          <div class="form-row">
            <div class="col-md-6 mb-3">
              ...
              <input type="url" class="form-control" name="facebook" value="{{ old('facebook', $about->facebook) }}" >
              @error('facebook')<div class="alert alert-danger mt-3">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-3 mb-3">
              <label for="instagram">{{__('keywords.instagram')}}</label>
              <input type="url" class="form-control" name="instagram" value="{{ old('instagram', $about->instagram) }}" >
              @error('instagram')<div class="alert alert-danger mt-3">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-3 mb-3">
              <label for="x">{{__('keywords.x')}}</label>
              <input type="url" class="form-control" name="x" value="{{ old('x', $about->x) }}" >
              @error('x')<div class="alert alert-danger mt-3">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-3 mb-3">
              <label for="linkedin">{{__('keywords.linkedin')}}</label>
              <input type="url" class="form-control" name="linkedin" value="{{ old('linkedin', $about->linkedin) }}" >
              @error('linkedin')<div class="alert alert-danger mt-3">{{ $message }}</div>@enderror
            </div>
          </div>
          ...
          <div class="custom-file mb-3">
            ...
            <label class="custom-file-label">{{__('keywords.image')}}...</label>
          </div>
          
          <div class="custom-file mb-3">
            <input type="file" class="custom-file-input" name="hero_img">
            <label class="custom-file-label">{{__('keywords.hero_img')}}...</label>
          </div>
